    ...
    <div class="main-container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li><a href="${pageContext.request.contextPath}/dashboard"><span class="icon">🏠</span><span class="label">Dashboard</span></a></li>
                <li><a href="${pageContext.request.contextPath}/historico" class="active"><span class="icon">📜</span><span class="label">Histórico</span></a></li>
                <li><a href="${pageContext.request.contextPath}/relatorio"><span class="icon">📊</span><span class="label">Relatório</span></a></li>
                <li><a href="${pageContext.request.contextPath}/perfil"><span class="icon">👤</span><span class="label">Perfil</span></a></li>
                <li><a href="${pageContext.request.contextPath}/logout"><span class="icon">🚪</span><span class="label">Sair</span></a></li>
            </ul>
        </div>
            ...
            <div class="content">
                ...
                <div class="card">
                    ...
                    <!-- ============================================
                         ...
                         - descricao
                    -->
                    <form method="POST" action="${pageContext.request.contextPath}/venda?acao=editar">
                        <!-- ID da venda (hidden) -->
                        ...
                        <div class="form-actions">
                            <a href="${pageContext.request.contextPath}/historico" class="btn btn-secondary">Cancelar</a>
