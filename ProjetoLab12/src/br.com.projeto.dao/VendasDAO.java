...
public class VendasDAO {
    ...
    public void inserir(Vendas venda) throws Exception {
        String sqlVenda = "INSERT INTO vendas (data_vendas, valor, nota_fiscal_emitida, categoria_id, usuario_id, descricao) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    // NOVO: Lista vendas por usuário com limite
    ...
    // NOVO: Calcula total de vendas do mês atual
    ...
    // NOVO: Lista vendas por mês e ano específico
    ...
    // NOVO: Lista anos que possuem vendas
    ...
    public void editar(Vendas venda) throws Exception {
        String sql = "UPDATE vendas SET data_vendas = ?, valor = ?, nota_fiscal_emitida = ?, categoria_id = ?, descricao = ? " +
                    "WHERE id_vendas = ?";
