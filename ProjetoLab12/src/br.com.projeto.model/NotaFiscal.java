...
public class NotaFiscal {
    ...
    private String numero;  // ALTERADO: int → String
    private Object dataEmissao;  // Aceita Date ou LocalDateTime
    private float valor;
    private int vendasId;  // ADICIONADO: FK para vendas
    private int usuarioId; // ADICIONADO: FK para usuario
